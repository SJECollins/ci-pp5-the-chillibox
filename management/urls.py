...
urlpatterns = [
    ...
    path('add_variant/', views.AddProductVariant.as_view(),
         name='add_variant'),
    path('edit_variant/<pk>', views.EditProductVariant.as_view(),
         name='edit_variant'),
    path('delete_variant/<pk>', views.DeleteProductVariant.as_view(),
         name='delete_variant'),
